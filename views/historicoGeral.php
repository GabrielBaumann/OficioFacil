<div class="bg-white rounded-lg border border-gray-100 p-6 shadow-sm">
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-lg font-semibold text-gray-900">Histórico geral</h2>
        <h2 class="text-xs font-semibold text-gray-900"><?= formatoNumero($totGeral ?? 0000); ?></h2>
    ...
    <?php if(!empty($historicoGeral)): ?>
        <!-- Histórico do usuáro -->
        <?php foreach($historicoGeral as $elemento): ?>
            <div class="space-y-3">
                <!-- Essa é a linha-->
