        ...
        <div class="mx-auto max-w-2xl py-20 sm:py-28 lg:py-32">
          <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div class="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Role a tela para baixo para ver o histórico ou <a href="#historico" class="font-semibold text-blue-800"><span class="absolute inset-0" aria-hidden="true"></span>Ver Histórico <span aria-hidden="true">&rarr;</span></a>
            </div>
          </div>
                ...
                <form action="<?= url("/of"); ?>" method="POST" class="mx-auto max-w-xl ">
                    ...
                    <div>
                        ...
                        <input type="number"
                                id="max-number"
                                name="max-number"
                                class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-800"
                    ...
                    <div class="sm:col-span-2">
                        <label for="message" class="block text-sm/6 font-semibold text-gray-900">Obervação (Opcional)</label>
                        <div class="mt-2.5">
                        <textarea name="message" id="message" rows="4" class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-800"></textarea>
                        </div>
                    </div>
                    </div>
                    <div class="mt-10">
